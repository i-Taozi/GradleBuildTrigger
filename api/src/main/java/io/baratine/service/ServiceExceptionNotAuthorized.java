...
public class ServiceExceptionNotAuthorized extends ServiceExceptionSecurity
{
  ...
  public ServiceExceptionNotAuthorized(String msg)
  {
    super(msg);
  }
  
  public ServiceExceptionNotAuthorized(Throwable exn)
  {
    super(exn);
  }
  
  public ServiceExceptionNotAuthorized(String msg, Throwable exn)
  {
    super(msg, exn);
  }
   ...
   */
  @Override
  public ServiceExceptionNotAuthorized rethrow(String msg)
  {
