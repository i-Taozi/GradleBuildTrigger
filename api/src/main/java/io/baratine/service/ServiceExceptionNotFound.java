...
public class ServiceExceptionNotFound extends ServiceException
{
  ...
  public ServiceExceptionNotFound(Throwable exn)
  {
    super(exn);
  }
  
  public ServiceExceptionNotFound(String msg, Throwable exn)
  {
    super(msg, exn);
  }
   ...
   */
  @Override
  public ServiceExceptionNotFound rethrow(String msg)
  {
    return new ServiceExceptionNotFound(msg, this);
  }
}
