...
public class ResultStreamServiceFilterSync<T> extends ResultStreamServiceBase<T,T>
{
  private PredicateSync<? super T> _test;
  
  public ResultStreamServiceFilterSync(ResultStream<? super T> result,
  ...
  {
    return new ResultStreamServiceFilterSync<>(result, _test);
  }
}
