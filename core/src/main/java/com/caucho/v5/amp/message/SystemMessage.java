 ...
 */
public final class SystemMessage extends MessageAmpBase
{
  private final InboxAmp _systemMailbox;

  public SystemMessage(final InboxAmp systemMailbox)
  ...
  {
    return _systemMailbox;
  }

  @Override
  public final WorkerDeliver worker()
  {
    return _systemMailbox.worker();
  }
