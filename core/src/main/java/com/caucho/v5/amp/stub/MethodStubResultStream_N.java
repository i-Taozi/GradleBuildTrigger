 ...
 */
class MethodStubResultStream_N extends MethodStubResult_N {
  private static final L10N L = new L10N(MethodStubResultStream_N.class);
  private static final Logger log
  = Logger.getLogger(MethodStubResultStream_N.class.getName());

  MethodStubResultStream_N(ServicesAmp ampManager, Method method)
