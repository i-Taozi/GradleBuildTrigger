...
abstract public class ResultStreamServiceBase<T,A>
  extends ResultStream.Wrapper<T,A>
{
  ResultStreamServiceBase(ResultStream<? super A> next)
  {
    super(next);
  }
  ...
  abstract public ResultStream<T> createMapSelf(ResultStream<? super A> resultReduce);
