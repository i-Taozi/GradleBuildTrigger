...
public class ResultStreamServiceFilterAsync<T>
  extends ResultStreamServiceBase<T,T>
{
  private PredicateAsync<? super T> _test;
  
  public ResultStreamServiceFilterAsync(ResultStream<? super T> result,
  ...
  {
    return new ResultStreamServiceFilterAsync<>(result, _test);
  }
}
