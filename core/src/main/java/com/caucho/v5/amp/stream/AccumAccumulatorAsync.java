...
public class AccumAccumulatorAsync<T,U>
  implements BiConsumerAsync<Accum<U>,T>
{
  private BiFunctionAsync<U,? super T,U> _accum;
  
  public AccumAccumulatorAsync(BiFunctionAsync<U,? super T,U> accum)
  {
    _accum = accum;
  }
