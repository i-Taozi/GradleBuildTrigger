 ...
 */
class MethodStubResultInPipe_N extends MethodStubResult_N
{
  private static final L10N L = new L10N(MethodStubResultInPipe_N.class);
  private static final Logger log
  = Logger.getLogger(MethodStubResultInPipe_N.class.getName());

  MethodStubResultInPipe_N(ServicesAmp ampManager, Method method)
