...
public class AmpExceptionUnknownServiceException extends AmpException {
  ...
  public AmpExceptionUnknownServiceException(ErrorCodeAmp code, String msg)
  {
    super(msg);
  }

  public AmpExceptionUnknownServiceException(String msg)
  {
    super(msg);
  }

  public AmpExceptionUnknownServiceException(Throwable e)
  {
    super(e);
  }

  public AmpExceptionUnknownServiceException(String msg, Throwable e)
  {
    super(msg, e);
  }
