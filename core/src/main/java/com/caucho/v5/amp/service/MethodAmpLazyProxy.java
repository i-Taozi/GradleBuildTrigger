 ...
 */
public class MethodAmpLazyProxy extends MethodAmpWrapper
{
  private MethodRefLazyProxy _methodRefLazy;
  
  private MethodAmp _delegate;

  public MethodAmpLazyProxy(MethodRefLazyProxy methodRefLazy)
  {
    _methodRefLazy = methodRefLazy;
  }
