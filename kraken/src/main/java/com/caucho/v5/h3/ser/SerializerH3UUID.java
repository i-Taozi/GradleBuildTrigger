...
public class SerializerH3UUID extends SerializerH3Base<UUID>
{
  @Override
  public int typeSequence()
  {
    return ConstH3.DEF_UUID;
  }
  ...
  @Override
  public UUID readObject(InRawH3 is, InH3Amp in)
  {
    String uuid = is.readString();
