...
/**
 * H3 map-typed serializer.
 */
public class SerializerH3MapPredef<T extends Map<?,?>> extends SerializerH3Map<T>
{
  private int _typeSequence;
  
  SerializerH3MapPredef(Class<? extends T> type, int typeSequence)
  {
    super(type);
