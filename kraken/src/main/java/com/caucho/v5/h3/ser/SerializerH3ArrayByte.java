 ...
 * byte[] serializer.
 */
public final class SerializerH3ArrayByte extends SerializerH3ValueBase<byte[]>
{
  SerializerH3ArrayByte()
  {
    super(byte[].class);
  }
  ...
  @Override
  public byte []readObject(InRawH3 is, InH3Amp in)
  {
    return is.readBinary();
  }

  @Override
  public void writeObject(OutRawH3 os, int defId, byte []value, OutH3 out)
  {
    os.writeBinary(value, 0, value.length);
  }
}
