...
public class SerializerH3RegexPattern extends SerializerH3Base<Pattern>
{
  @Override
  ...
  @Override
  public Pattern readObject(InRawH3 is, InH3Amp in)
  {
    String pattern = is.readString();

    int flags = (int) is.readLong();
                          ...
                          OutH3 out)
  {
    ...
    os.writeString(pattern.pattern());

    os.writeLong(pattern.flags());
  }
}
