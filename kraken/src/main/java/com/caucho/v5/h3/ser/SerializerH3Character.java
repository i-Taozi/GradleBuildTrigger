...
public class SerializerH3Character extends SerializerH3Base<Character>
{
  @Override
  public int typeSequence()
  {
    return ConstH3.DEF_CHAR;
  }
  ...
  @Override
  public Character readObject(InRawH3 is, InH3Amp in)
  {
    return new Character((char) is.readLong());
  }

  @Override
  public void writeObject(OutRawH3 os, int defId, Character c, OutH3 out)
  {
