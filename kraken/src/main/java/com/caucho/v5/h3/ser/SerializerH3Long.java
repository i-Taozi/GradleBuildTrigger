 ...
 * long serializer.
 */
public final class SerializerH3Long extends SerializerH3ValueBase<Long>
{
  SerializerH3Long()
  {
    super(Long.class);
  ...
  @Override
  public Long readObject(InRawH3 is, InH3Amp in)
  {
    return new Long((int) is.readLong());
  }

  @Override
  public void writeObject(OutRawH3 os, int defId, Long value, OutH3 out)
  {
    os.writeLong(value);
  }
}
