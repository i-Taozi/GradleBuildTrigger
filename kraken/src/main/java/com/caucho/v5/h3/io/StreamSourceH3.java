...
/**
 * Stream source for H3 serialization of large data
 */
public interface StreamSourceH3
{
  default public int useCount() { return 0; }
  
  /**
   * Adds a use-counter, so getInputStream can be called multiple times.
   */
  default public void addUseCount()
  {
  }
   ...
   */
  default public void freeUseCount()
  {
  }
   ...
   */
  default public long length() { return 0; }
