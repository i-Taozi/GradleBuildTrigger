 ...
 * float serializer.
 */
public final class SerializerH3Float extends SerializerH3ValueBase<Float>
{
  SerializerH3Float()
  {
    super(Float.class);
  ...
  @Override
  public Float readObject(InRawH3 is, InH3Amp in)
  {
    return new Float(is.readFloat());
  }

  @Override
  public void writeObject(OutRawH3 os, int defId, Float value, OutH3 out)
  {
    os.writeFloat(value);
  }
}
