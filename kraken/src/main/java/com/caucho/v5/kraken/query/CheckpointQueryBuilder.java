...
public class CheckpointQueryBuilder extends QueryBuilderKraken
{
  ...
  public CheckpointQueryBuilder(KrakenImpl tableManager, String sql)
  {
    super(sql);
  ...
  {
    result.ok(new CheckpointQuery(this));
  }
