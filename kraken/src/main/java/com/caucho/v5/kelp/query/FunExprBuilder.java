 ...
 * Query based on SQL.
 */
public class FunExprBuilder extends ExprBuilderKelp
{ 
  private final ExprBuilderKelp _expr;
  private final Function<Object,Object> _fun;
  
  FunExprBuilder(ExprBuilderKelp expr,
  ...
  public ExprKelp build(QueryBuilder builder)
  {
    ...
    return new FunExprKelp(expr, _fun);
  }
  
  @Override
  public String toString()
  {
    return _fun.getClass().getSimpleName() + "(" + _expr + ")";
  }
}
