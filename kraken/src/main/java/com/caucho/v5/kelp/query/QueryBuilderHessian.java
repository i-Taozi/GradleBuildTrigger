 ...
 */
public class QueryBuilderHessian extends QueryBuilder
{
  private static final L10N L = new L10N(QueryBuilderHessian.class);
  
  private ExprKelp _expr;
  
  private PathKelp _pathKelp = new PathKelpHessian();
  ...
  */
  ...
  public EnvKelp build(ExprBuilderKelp exprBuilder)
  {
    ...
    PathKelp []paths = new PathKelp[] { _pathKelp };
