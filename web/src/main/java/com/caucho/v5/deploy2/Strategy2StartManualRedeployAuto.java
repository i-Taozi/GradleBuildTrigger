 ...
 * </table>
 */
class Strategy2StartManualRedeployAuto<I extends DeployInstance2>
  extends Strategy2StartManualRedeployManual<I>
{
  private final static Strategy2StartManualRedeployAuto<?> STRATEGY
    = new Strategy2StartManualRedeployAuto<>();

  protected Strategy2StartManualRedeployAuto()
  {
  }
