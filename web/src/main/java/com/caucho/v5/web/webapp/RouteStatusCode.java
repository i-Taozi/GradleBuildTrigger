 ...
 */
public class RouteStatusCode implements RouteBaratine
{
  private HttpStatus _status;
  
  public RouteStatusCode(HttpStatus status)
  {
  ...
  public boolean service(RequestBaratine request)
  {
    ...
    request.write("Status: " + _status);// + " " + request.getStatusMessage());
    request.ok();
  ...
  {
    return getClass().getSimpleName() + "[" + _status + "]";
  }
}
