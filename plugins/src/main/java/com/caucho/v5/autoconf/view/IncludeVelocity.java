...
import com.caucho.v5.view.velocity.ViewVelocity;

/**
 * mustache view configuration.
 */
@Include
@IncludeOnClass(org.apache.velocity.app.VelocityEngine.class)
public class IncludeVelocity
{
  private @Inject Config _config;

  public IncludeVelocity()
  {
  }
