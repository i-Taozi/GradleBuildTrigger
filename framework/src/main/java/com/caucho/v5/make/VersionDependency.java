...
/**
 * Representing the server's version.
 */
public class VersionDependency implements PersistentDependency {
  ...
  {
    _version = CauchoUtil.getFullVersion();
  }
  ...
  {
    return ! CauchoUtil.getFullVersion().equals(_version);
  }
  ...
  {
    return ("new com.caucho.v5.make.VersionDependency(" +
            "\"" + _version + "\")");
  }
}
