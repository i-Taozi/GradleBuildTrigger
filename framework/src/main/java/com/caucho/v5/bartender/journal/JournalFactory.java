 ...
 */
class JournalFactory implements Supplier<ServiceWebSocket>
{
  private JournalSystem _journalSystem;

  JournalFactory(JournalSystem journalSystem)
  {
    _journalSystem = journalSystem;
  }
  
  JournalStream openJournal(String name)
  {
    return _journalSystem.openJournalFullName(name);
  }

  @Override
  public ServiceWebSocket get()
  {
    return new JournalServerEndpoint(this);
  }
}
