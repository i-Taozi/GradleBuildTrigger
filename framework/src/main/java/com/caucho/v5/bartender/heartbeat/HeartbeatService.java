...
{
  public static final String PATH = "/bartender-heartbeat";
  
  void join(String extAddress, int extPort,
            String clusterId,
            String address, int portPublic, int portBartender, 
            String displayName, 
            String serverHash,
            int seedIndex,
            Result<UpdateRackHeartbeat> result);

  void serverHeartbeat(UpdateServerHeartbeat updateServer);
