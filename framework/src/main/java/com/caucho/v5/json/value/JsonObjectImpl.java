...
{
  private final Map<String,JsonValue> _value;

  public JsonObjectImpl(Map<String,JsonValue> value)
  {
    _value = value;
  }
  ...
  @Override
  public JsonObject getJsonArray(int index)
  {
    return null;
  }
  ...
  {
    JsonValue value = _value.get(key);
    
    if (value != null) {
      return value;
    }
    else {
      return JsonValueBase.NULL;
    }
  }
