...
public class Base64Web {
  ...
  {
    cb.append(Base64Web.encode(data >> 60));
    cb.append(Base64Web.encode(data >> 54));
    cb.append(Base64Web.encode(data >> 48));
    cb.append(Base64Web.encode(data >> 42));
    cb.append(Base64Web.encode(data >> 36));
    cb.append(Base64Web.encode(data >> 30));
    cb.append(Base64Web.encode(data >> 24));
    cb.append(Base64Web.encode(data >> 18));
    cb.append(Base64Web.encode(data >> 12));
    cb.append(Base64Web.encode(data >> 6));
    cb.append(Base64Web.encode(data));
  }
