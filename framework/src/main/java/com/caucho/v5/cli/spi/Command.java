...
public interface Command<A extends ArgsBase>
{
  ...
  OptionCommandLine<? super A> getOption(String arg);

  default int getTailArgsMinCount()
  {
    return -1;
  }
  ...
  default String usage(ArgsBase args)
  {
    StringBuilder sb = new StringBuilder();

    sb.append("\n  unknown usage ").append(name());
    ...
    implements Command<X>
  {
    ...
    @Override
    public OptionCommandLine<? super X> getOption(String arg)
    {
      return null;
    }
