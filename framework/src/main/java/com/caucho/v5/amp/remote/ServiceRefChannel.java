 ...
 */
public class ServiceRefChannel extends ServiceRefBase
{
  private final ChannelAmp _channel;
  
  public ServiceRefChannel(ChannelAmp channel)
  {
    _channel = channel;
  }
  ...
  {
    return _channel.createGatewayRef(path);
  }
}
