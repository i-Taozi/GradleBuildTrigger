 ...
 */
class MarshalEnum implements ModuleMarshal
{
  private final Class<?> _sourceClass;
  private final Class<?> _targetClass;

  MarshalEnum(RampImport moduleImport,
              Class<?> sourceClass,
              Class<?> targetClass)
  {
    ...
    moduleImport.addMarshalRef(sourceClass, targetClass, this);
  }
  ...
  public Object convert(Object sourceValue)
  {
    ...
    Object value = Enum.valueOf((Class) _targetClass, ((Enum) sourceValue).toString());
